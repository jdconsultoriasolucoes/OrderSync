...
from routers import system_tables, transporte, relatorios, vendedores, catalogo_referencias, retiradas, auditoria
...
from routers import calendarios, eventos, perfis
...
if os.path.exists(static_dir):
    for item in os.listdir(static_dir):
        ...
        if os.path.isdir(full_path):
            ...
            # Using NoCacheStaticFiles to ensure updates are served immediately
            app.mount(f"/{item}", NoCacheStaticFiles(directory=full_path), name=item)
